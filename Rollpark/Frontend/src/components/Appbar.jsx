...
export function Appbar({setQuote,setMenu}){
  
    return (
      <>
        <div className='md:grid max-sm:hidden w-full shadow-lg p-4 pt-5 pb-4 bg-white  grid-cols-5 fixed font-bold text-slate-400 z-30 '>
          ...
          <div className='flex flex-col justify-center'>
            ...
            <div className='border border-slate-700 bg-green-300 hover:bg-orange-500 hover:text-slate-400 rounded-3xl'>
              ...
              {/* below mid */}
        <div className='md:hidden sm:hidden w-full shadow-lg p-8 pt-5 pb-4 bg-white grid  grid-cols-2 fixed font-bold text-slate-400 z-30 '>
          <div className="flex">
