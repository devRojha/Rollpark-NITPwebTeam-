    ...
    return (
        <div className='flex border border-slate-200 bg-slate-50 pb-5 z-10'>
          ...
          <div className='sm:flex hidden flex-col justify-center absolute lg:right-34 right-10'>
            <img className='h-40 z-30 flex relative bottom-[-60px]' src="icon/spec-layer-1.png" alt="L" />
            <img className='h-40 z-20 flex relative bottom-[20px]' src="icon/spec-layer-2.png" alt="L" data-aos="fade-down"/>
            <img className='h-40 z-10  flex relative bottom-[100px] ' src="icon/spec-layer-3.png" alt="L" data-aos="fade-down"/>
            {/* -20 -180 -340 */}
          </div>
        </div>
    )
