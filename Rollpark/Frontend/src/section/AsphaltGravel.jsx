        ...
        <div className='bg-white shadow-md border'>
          ...
          <div className='flex justify-center mt-4'>
            <div className='grid grid-cols-3 w-[60%] md:text-1xl max-md:text-[10px] max-sm:text-[7px] pb-4'>
              <div className='flex'>
                <img className='h-8 max-sm:h-3' src="icon/icon04.png" alt="I" data-aos="fade"/>
          ...
          <GreedComponent icon={"icon/icon04.png"} first={"Cannot be reused"} second={"Re-usable"} third={"Not usually reused"}/>
          <div className='flex justify-center mt-4'>
            <div className='grid grid-cols-3 w-[60%] md:text-1xl max-md:text-[10px] max-sm:text-[7px] pb-4'>
              <div className='flex'>
                <img className='h-8 max-sm:h-3' src="icon/icon04.png" alt="I" data-aos="fade"/>
          ...
          <GreedComponent icon={"icon/icon04.png"} first={"2-3 weeks per acre"} second={"1 week per acre"} third={"-1 week per acre"}/>
          <GreedComponent icon={"icon/icon04.png"} first={"ADA accessible"} second={"ADA accessible"} third={"Not ADA accessible"}/>
          <GreedComponent icon={"icon/icon04.png"} first={"No LEED"} second={"Up to 7 LEED"} third={"No LEED"}/>
          <GreedComponent icon={"icon/icon04.png"} first={"Cannot be rented"} second={"Rentable"} third={"Cannot be rented"}/>
