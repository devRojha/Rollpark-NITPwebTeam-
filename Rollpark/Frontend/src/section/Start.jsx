      ...
      <>
        <div className='md:hidden  max-md:h-[100vh] lg:h-[80vh]'>
          ...
          <div className='h-full overflow-hidden'>
            <video className={`${fullPlay?"fixed h-screen w-100vw z-40":"h-full"} object-cover bg-white`} autoPlay src="icon/hero.mp4"></video>
          </div>
        </div>
        {/* after mid */}
        <div className='max-md:hidden h-[80vh] '>
          ...
          <div className='h-full overflow-hidden'>
            <video className={`${fullPlay?"fixed h-screen w-100vw z-40":"h-full w-full"} object-cover bg-white`} autoPlay src="icon/hero.mp4"></video>
          </div>
        </div>
      </>
    )
