    ...
    return(
        <div className="bg-white">
            ...
            <div className=' w-[80%] lg:ml-40 md:ml-20 ml-10 mt-4 mb-8 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-7'>
                ...
                }} caption={"Autologistics"} icon={"icon/truck.png"}/>
                <Tailored onClick={()=>{
                ...
                }} caption={"Auto-manuacturing"} icon={"icon/truck2.png"}/>
                <Tailored onClick={()=>{
                ...
                }} caption={"Events"} icon={"icon/calender.png"}/> 
                <Tailored onClick={()=>{
                ...
                }} caption={"Hollywood"} icon={"icon/chair.png"}/>
                <Tailored onClick={()=>{
                ...
                }} caption={"Permitting Restrictions"} icon={"icon/drop.png"}/>
                <Tailored onClick={()=>{
                ...
                }} caption={"Universities"} icon={"icon/clock.png"}/>
                <Tailored onClick={()=>{
                ...
                }} caption={"Parking Managers"} icon={"icon/truck.png"}/>
            </div>
            </div>
