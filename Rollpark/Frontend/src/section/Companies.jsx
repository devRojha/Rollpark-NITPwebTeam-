        ...
        <div className='flex flex-col bg-white border pb-11 pt-11'>
          ...
          <div className='grid lg:grid-cols-8 md:grid-cols-3  lg:ml-40 md:ml-20 ml-10  mb-8 p-4 w-[70%]'>
            <div className=' flex justify-center mb-6'>
              <img className=' h-6 flex justify-center' src="icon/company-logo-1.jpg" alt="" data-aos="fade-up"/>
            </div>
            <div className=' flex justify-center mb-6'>
              <img className=' h-6 flex justify-center' src="icon/company-logo-2.jpg" alt="" data-aos="fade-up"/>
            </div><div className=' flex justify-center mb-6'>
              <img className=' h-6 flex justify-center' src="icon/company-logo-4.jpg" alt="" data-aos="fade-up"/>
            </div><div className=' flex justify-center mb-6'>
              <img className=' h-6 flex justify-center' src="icon/company-logo-5.jpg" alt="" data-aos="fade-up"/>
            </div><div className=' flex justify-center mb-6'>
              <img className=' h-6 flex justify-center' src="icon/company-logo-6.jpg" alt="" data-aos="fade-up"/>
            </div><div className=' flex justify-center mb-6'>
              <img className=' h-6 flex justify-center' src="icon/company-logo-7.jpg" alt="" data-aos="fade-up"/>
            </div><div className=' flex justify-center mb-6'>
              <img className=' h-6 flex justify-center' src="icon/company-logo-8.jpg" alt="" data-aos="fade-up"/>
            </div><div className=' flex justify-center mb-6'>
              <img className=' h-6 flex justify-center' src="icon/company-logo-9.jpg" alt="" data-aos="fade-up"/>
            </div>
          </div>
          <div className='grid lg:grid-cols-2 md:grid-cols-1 m-2'>
            <div className='h-[500px] border flex flex-col justify-center'>
              <img className="h-full" src="icon/gallery1.png" alt="" data-aos="fade-up"/>
            </div>
            <div className='h-[500px] border flex flex-col justify-center'>
              <img className="h-full" src="icon/gallery2.png" alt="" data-aos="fade-up"/>
            </div>
            <div className='h-[500px] border flex flex-col justify-center'>
              <img className="h-full" src="icon/gallery3.png" alt="" data-aos="fade-up"/>
            </div>
            <div className='h-[500px]  mr-2 flex  justify-center'>
              <div className='flex flex-col justify-center'>
                <div className='m-auto  w-[80%] h-[70%]'>
                  ...
                  <img className='mt-3 h-20' src="icon/DeanAnos.png" alt="L" data-aos="fade-up"/>
                </div>
              </div>
            </div>
          </div>
