            ...
            <div className='h-[100%]  bg-white grid lg:grid-cols-5 md:grid-cols-2 pl-8 pr-20'>
                <div className='flex flex-col justify-center w-[200px] mt-4 mb-4'>
                    <div className='flex justify-center text-3xl'>
                        <img className="h-6 m-3" src="icon/icon01.png" alt="Loading.."/>
                ...
                <Info title={"80%"} descrioption={"less construction time than conventional lots"} icon={"icon/icon02.png"} />
                <Info title={"7y"} descrioption={"durable enough to last for up to 7 years"} icon={"icon/icon03.png"} />
                <Info title={"100%"} descrioption={"permeability protects surrounding land"} icon={"icon/icon04.png"}/>
                <div className='flex'>
